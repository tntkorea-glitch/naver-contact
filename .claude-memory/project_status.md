...
- **Vercel 배포 URL** = https://listica-contact.vercel.app (Vercel 프로젝트 이름은 `contica`로 변경 완료(2026-04-18), 다만 alias는 구 URL인 `listica-contact.vercel.app` 그대로. `contica.vercel.app`은 타 유저가 선점. 나중에 `contica.co.kr` 도메인 구매 예정)
